<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/bootstrap-theme.min.css" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/bootstrap.css" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/bootstrap.css.map" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/bootstrap.min.css" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/font-awesome.css" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/font-awesome.min.css" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/prettyPhoto.css" ></c:url>' />
    <link rel="stylesheet" type="text/css" href='<c:url value="/css/responsive.css" ></c:url>' />
